...
console.log(fs.createReadStream(audioFile.path))
    ...
    const response = await axios.post(`http://localhost:3333/message/audiofile?key=${instanceKey}`, formData, {
      headers: {
        ...formData.getHeaders(),
        'accept': '*/*',
        ...
        'Referer': `http://localhost:3333/chat?num=${chatId}&key=${instanceKey}`,
